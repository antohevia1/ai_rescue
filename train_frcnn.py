...
def write_log(callback, names, logs, batch_no):
    ...
    with callback.as_default():
        ...
        # other model code would go here
            tf.summary.scalar(i, logs[n], step=batch_no)
        callback.flush()
...
print(('Num  samples {}'.format(num_imgs)))
...
# Tensorboard log
callback = tf.summary.create_file_writer(log_path)
...
class_mapping_inv = {v: k for k, v in list(class_mapping.items())}
